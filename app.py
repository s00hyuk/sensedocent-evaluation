...
GLOBAL_CHOICES = [
    ("사실과 시각 정보를 간결하게 전달하는 설명 (캡션형)", "caption"),
    ("작가 배경과 작품의 맥락을 풀어주는 설명 (도슨트형)", "docent"),
    ("분위기·촉감·감정 등 다양한 감각으로 표현한 설명 (감각형)", "sensedocent"),
    ("잘 모르겠다", "unsure"),
]
...
<div class="sd-consent-text">
  <h2>전체 평가</h2>
  <p>모든 음성 설명을 들으셨습니다. 마지막으로 <strong>세 가지 설명 방식 전반</strong>에 대해 비교해 주세요.</p>
  <p>방금 들으신 세 가지 설명 방식은 각각 다음과 같은 특성이 있었습니다.</p>
  <ul>
    <li><strong>캡션형</strong> — 사실과 시각 정보를 간결하게 전달하는 설명</li>
    <li><strong>도슨트형</strong> — 작가 배경과 작품의 맥락을 풀어주는 설명</li>
    <li><strong>감각형</strong> — 분위기·촉감·감정 등 다양한 감각으로 표현한 설명</li>
  </ul>
</div>
"""
